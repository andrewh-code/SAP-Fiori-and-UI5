sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("training/fiori/i849467/product/manage/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#Product-manage&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#Product-manage";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("training.fiori.i849467.product.manage.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["training/fiori/i849467/product/manage/localService/mockserver"], function (mockserver) {
